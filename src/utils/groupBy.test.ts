...
const groupByName = {
  Tirion: [{ name: 'Tirion', class: 'B', mark: 2 }],
  Keit: [
    { name: 'Keit', class: 'A', mark: 3 },
    { name: 'Keit', class: 'B', mark: 4 },
  ],
  Ramsey: [{ name: 'Ramsey', class: 'A', mark: 4 }],
  Bronn: [{ name: 'Bronn', class: 'B', mark: 3 }],
  Sam: [{ name: 'Sam', class: 'A', mark: 2 }],
  Aria: [{ name: 'Aria', class: 'B', mark: 5 }],
  Rob: [{ name: 'Rob', class: 'B', mark: 4 }],
  Taywin: [{ name: 'Taywin', class: 'A', mark: 5 }],
};
